...
const CreateProblemfrom = () => {
    ...
    const {
        ...
        remove: removeTestCase, replace: reolaceTestCase
    ...
    const {
        fields: tagFields,
        append: appendTag,
        remove: removeTag, replace: reolaceTag
    ...
    const loadSampleData=()=>{
        ...
        reolaceTag(sampleData.tags.map((tag)=>tag))
        reolaceTag(sampleData.testcases.map((tc)=>tc))
        reset(sampleData)
    }
